...
public class su {
	...
	public static void init() {
		try {  
			Runtime.getRuntime().addShutdownHook(new Thread(){
				...
				@Override
				public void run() {
				ff.sc("	Runtime Exception reboot...");
				}});
	...
	public static String exec(String cmd) {        
		try {
			...
			//outStream.writeBytes(new String( (cmd+"\n").getBytes(),"utf-8"));
			    
			outStream.writeBytes(Sendend);
			retrieve r = new retrieve(proc.getInputStream());
			r.start();
